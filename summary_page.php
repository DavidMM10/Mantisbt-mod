...
//Tabla para KPIs
$t_summary_header_kpi_arr = explode( '/', lang_get( 'summary_header_kpi' ) );

$t_summary_header_kpi2_arr = explode( '/', lang_get( 'summary_header_kpi2' ) );

$t_summary_header_cobertura_bugs_arr = explode( '/', lang_get( 'summary_header_cobertura_bugs' ) );

$t_summary_header_kpi = '';
foreach ( $t_summary_header_kpi_arr as $t_summary_header_kpi_name ) {
	$t_summary_header_kpi .= '<th class="align-right">';
	$t_summary_header_kpi .= $t_summary_header_kpi_name;
	$t_summary_header_kpi .= '</th>';
}

$t_summary_header_kpi2 = '';
foreach ( $t_summary_header_kpi2_arr as $t_summary_header_kpi2_name ) {
	$t_summary_header_kpi2 .= '<th class="align-right">';
	$t_summary_header_kpi2.= $t_summary_header_kpi2_name;
	$t_summary_header_kpi2 .= '</th>';
}

$t_summary_header_cobertura_bugs = '';
foreach ( $t_summary_header_cobertura_bugs_arr as $t_summary_header_cobertura_bugs_name ) {
	$t_summary_header_cobertura_bugs .= '<th class="align-right">';
	$t_summary_header_cobertura_bugs.= $t_summary_header_cobertura_bugs_name;
	$t_summary_header_cobertura_bugs .= '</th>';
}
...
<!-- PRIMER KPI 
	NUMERO DE BUGS POR LINEAS DE CODIGO -->
	...
	<div class="widget-box table-responsive">
		...
		<thead>
			<tr>				
				<th class="width-35"><?php echo lang_get( 'kpi' ) ?></th>
				<?php echo $t_summary_header_kpi ?>
			</tr>
		</thead>
		<?php summary_kpi( array(), null, null, $t_filter ); ?>
	</table>
	</div>
...
<!-- SEGUNDO KPI 
	DEFECTOS IDENTIFICADOS EN CERTIFICACION -->
	<div class="space-10"></div>
	<div class="widget-box table-responsive">
		<table class="table table-hover table-bordered table-condensed table-striped">
		<thead>
			<tr>
				<th class="width-35"><?php echo lang_get( 'kpi2' ) ?></th>
				<?php echo $t_summary_header_kpi2 ?>
			</tr>
		</thead>
		<?php summary_kpi2( array(), null, null, $t_filter ); ?>
	</table>
	</div>
...
<!-- TERCER KPI 
	...
	<div class="widget-box table-responsive">
		...
		<thead>
			<tr>
				<th class="width-35"><?php echo lang_get( 'cobertura_bugs' ) ?></th>
				<?php echo $t_summary_header_cobertura_bugs ?>
			</tr>
		</thead>
		<?php summary_cobertura_bugs( array(), null, null, $t_filter ); ?>
	</table>
	</div>
